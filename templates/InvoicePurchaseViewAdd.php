    ...
    public static function render($params = [])
    {
        ...
        <section class ="box-section">
            <form class="box-form" method="post" action="" enctype="multipart/form-data">
                ...
                <input id="id-invoice-purchase" type="text" name="idinvoice" placeholder="Invoice id" required="required" pattern='[/\A-Z0-9]*'>
                <input id="number-invoice-purchase" type="text" name="numberinvoice" placeholder="Invoice number" required="required" pattern='[/\A-Z0-9]*'>
